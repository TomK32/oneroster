class Oneroster
  class Client
    ...
    BASE_URI = 'https://oneroster.infitecampus.org/campus/oneroster/entropyMaster/learningdata/v1/'
    base_uri BASE_URI
    ...
    def initialize(api_credentials, options = {})
      ...
      @options = {:headers => {'User-Agent' => "Ruby Oneroster #{VERSION}", 'Accept' => 'application/json', 'Content-Type' => 'application/json'}}.merge(options)
    end
